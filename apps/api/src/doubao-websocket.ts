...
export {
  ...
  buildDoubaoSessionConfig,
} from "./doubao-session.js";
export type { DoubaoSessionConfig } from "./doubao-session.js";
...
export function buildDoubaoSessionCreateEvent(
  ...
  return {
    ...
    type: "session.create",
    session: buildDoubaoSessionConfig(model, runtime),
  };
}
...
export function isAllowedDoubaoClientEvent(message: Buffer): boolean {
  return readAllowedDoubaoClientEventType(message) !== null;
}
